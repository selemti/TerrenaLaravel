...
try {
    ...
    DB::connection('pgsql')->table('selemti.items')->insertOrIgnore([
        'id' => 'CAT-ROOT', 'nombre' => 'Main Category', 'unidad_medida' => 'PZ', 'perishable' => false, 'activo' => true
    ]);

    // Create Category (Test)
    DB::connection('pgsql')->table('selemti.items')->insert([
        'id' => $cat, 'nombre' => 'Categoria de Prueba', 'unidad_medida' => 'PZ', 'perishable' => false, 'activo' => true, 'categoria_id' => 'CAT-ROOT'
    ]);
