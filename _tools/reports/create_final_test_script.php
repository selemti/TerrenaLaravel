<?php
/**
 * Create final test script to verify exact Floreant calculation
 */
...
foreach (\$tickets as \$ticket) {
    echo "Ticket {\$ticket['id']}: Items=\\${\$ticket['items_total']}, Modifiers=\\${\$ticket['modifiers_total']}, Discounts=\\${\$ticket['ticket_discounts'] + \$ticket['item_discounts']}, Final=\\${\$ticket['total_price']}\\n";
...
// Write the final test script
file_put_contents('C:\\xampp3\\htdocs\\TerrenaLaravel\\final_test_floreant.php', $finalTestScript);

echo "✅ Final test script created: final_test_floreant.php\n\n";
echo "This script will:\n";
echo "1. Execute the exact Floreant calculation\n";
echo "2. Compare results with expected totals\n";
echo "3. Analyze individual tickets\n";
echo "4. Provide final validation\n\n";
echo "Next step: Run the script with:\n";
echo "php final_test_floreant.php\n";
?>