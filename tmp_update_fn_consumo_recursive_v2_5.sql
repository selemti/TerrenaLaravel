-- =============================================================================
-- REFACTORIZACIÓN FINAL: fn_expandir_consumo_ticket (v2.5)
-- SOPORTE: Recursividad Logística + Stock-Aware + Modificadores (Final Fix)
-- =============================================================================
...
BEGIN
    ...
    LOOP
        ...
        SELECT 
            ...
            COALESCE(substring(b.item_id from '[0-9]+')::integer, 0),
            COALESCE(u.id, 3),
    ...
    VALUES (_ticket_id, 'EXPAND_V2_5', jsonb_build_object('ts', now()));
END;
$function$;
