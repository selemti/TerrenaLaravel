...
class ItemModsReportService
{
    ...
    protected function fetchItemModifierCombos(
        ...
        $rows = DB::connection('pgsql')
            ...
            ->selectRaw("
                ...
                COALESCE(ti.total_price_without_modifiers, ti.item_price * COALESCE(ti.item_count, 1)) AS total_sin_mods,
        ...
        if ($includeEmpty) {
            $this->addItemsWithoutModifiers($result, $start, $end, $branchIds, $terminalIds);
        }
     ...
     */
    protected function addItemsWithoutModifiers(Collection &$result, Carbon $start, Carbon $end, ?array $branchIds, ?array $terminalIds): void
    {
