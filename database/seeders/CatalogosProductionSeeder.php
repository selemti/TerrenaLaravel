...
class CatalogosProductionSeeder extends Seeder
{
    ...
    private function seedUnidades(): void
    {
        ...
        $canonicas = [
            ...
            ['clave' => 'G', 'nombre' => 'Gramo'],
            ['clave' => 'GR', 'nombre' => 'Gramo'],
            ['clave' => 'MG', 'nombre' => 'Miligramo'],
            ['clave' => 'TON', 'nombre' => 'Tonelada'],
            ['clave' => 'LB', 'nombre' => 'Libra'],
            ['clave' => 'OZ', 'nombre' => 'Onza'],
            ['clave' => 'L', 'nombre' => 'Litro'],
            ['clave' => 'LT', 'nombre' => 'Litro'],
            ['clave' => 'ML', 'nombre' => 'Mililitro'],
            ['clave' => 'M3', 'nombre' => 'Metro cúbico'],
            ['clave' => 'GAL', 'nombre' => 'Galón'],
            ['clave' => 'FLOZ', 'nombre' => 'Onza fluida'],
            ['clave' => 'CUP', 'nombre' => 'Taza'],
            ['clave' => 'TAZA', 'nombre' => 'Taza'],
            ['clave' => 'TBSP', 'nombre' => 'Cucharada'],
            ['clave' => 'TSP', 'nombre' => 'Cucharadita'],
            ['clave' => 'CDSP', 'nombre' => 'Cucharada sopera'],
            ['clave' => 'CDTA', 'nombre' => 'Cucharadita'],
            ['clave' => 'PZ', 'nombre' => 'Pieza'],
            ['clave' => 'PZA', 'nombre' => 'Pieza'],
            ['clave' => 'PAQ', 'nombre' => 'Paquete'],
            ['clave' => 'CAJ', 'nombre' => 'Caja'],
            ['clave' => 'COST', 'nombre' => 'Costal'],
            ['clave' => 'PORC', 'nombre' => 'Porción'],
            ['clave' => 'PLAT', 'nombre' => 'Plato'],
            ['clave' => 'MIN', 'nombre' => 'Minuto'],
            ['clave' => 'HR', 'nombre' => 'Hora'],
        ];
        ...
        if ($this->tableExists('selemti.unidades_medida_legacy')) {
            $legacyRows = [
                ...
                ['codigo' => 'G', 'nombre' => 'Gramo', 'tipo' => 'PESO', 'categoria' => 'METRICO', 'es_base' => false, 'factor_conversion_base' => 0.001, 'decimales' => 1],
                ...
                ['codigo' => 'L', 'nombre' => 'Litro', 'tipo' => 'VOLUMEN', 'categoria' => 'METRICO', 'es_base' => true, 'factor_conversion_base' => 1.0, 'decimales' => 3],
                ['codigo' => 'ML', 'nombre' => 'Mililitro', 'tipo' => 'VOLUMEN', 'categoria' => 'METRICO', 'es_base' => false, 'factor_conversion_base' => 0.001, 'decimales' => 0],
                ['codigo' => 'M3', 'nombre' => 'Metro cúbico', 'tipo' => 'VOLUMEN', 'categoria' => 'METRICO', 'es_base' => false, 'factor_conversion_base' => 1000.0, 'decimales' => 3],
                ...
                ['codigo' => 'TAZA', 'nombre' => 'Taza', 'tipo' => 'VOLUMEN', 'categoria' => 'CULINARIO', 'es_base' => false, 'factor_conversion_base' => 0.24, 'decimales' => 2],
                ...
                ['codigo' => 'TBSP', 'nombre' => 'Cucharada', 'tipo' => 'VOLUMEN', 'categoria' => 'CULINARIO', 'es_base' => false, 'factor_conversion_base' => 0.015, 'decimales' => 1],
                ['codigo' => 'TSP', 'nombre' => 'Cucharadita', 'tipo' => 'VOLUMEN', 'categoria' => 'CULINARIO', 'es_base' => false, 'factor_conversion_base' => 0.005, 'decimales' => 1],
