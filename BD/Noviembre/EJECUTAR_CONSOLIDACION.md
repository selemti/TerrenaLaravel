...
```bash
cd C:/xampp3/htdocs/TerrenaLaravel/BD/Noviembre
...
bash BD/Noviembre/00_verificar_referencias_codigo.sh
```
...
PGPASSWORD=T3rr3n4#p0s "C:/Program Files (x86)/PostgreSQL/9.5/bin/psql.exe" \
  -h localhost -p 5433 -U postgres -d pos \
  -f BD/Noviembre/01_agregar_campos_users.sql
```
...
PGPASSWORD=T3rr3n4#p0s "C:/Program Files (x86)/PostgreSQL/9.5/bin/psql.exe" \
  -h localhost -p 5433 -U postgres -d pos \
  -f BD/Noviembre/02_agregar_codigo_roles.sql
```
...
PGPASSWORD=T3rr3n4#p0s "C:/Program Files (x86)/PostgreSQL/9.5/bin/psql.exe" \
  -h localhost -p 5433 -U postgres -d pos \
  -f BD/Noviembre/03_drop_tables_legacy.sql
```
...
PGPASSWORD=T3rr3n4#p0s "C:/Program Files (x86)/PostgreSQL/9.5/bin/psql.exe" \
  -h localhost -p 5433 -U postgres -d pos \
  -f BD/Noviembre/04_drop_tables_catalogs_empty.sql
```
...
PGPASSWORD=T3rr3n4#p0s "C:/Program Files (x86)/PostgreSQL/9.5/bin/psql.exe" \
  -h localhost -p 5433 -U postgres -d pos \
  -f BD/Noviembre/05_drop_tables_cash_fund_empty.sql
```
...
PGPASSWORD=T3rr3n4#p0s "C:/Program Files (x86)/PostgreSQL/9.5/bin/psql.exe" \
  -h localhost -p 5433 -U postgres -d pos \
  -f BD/Noviembre/06_drop_tables_users_roles.sql
```
