...
Archivo: `BD/Noviembre/10_11_2025/CREATE_VW_SESION_DPR.sql`
...
"C:/Program Files (x86)/PostgreSQL/9.5/bin/psql.exe" -h localhost -p 5433 -U postgres -d pos -f "BD/Noviembre/10_11_2025/CREATE_VW_SESION_DPR.sql"
```
...
```bash
# Subir script
pscp -pw T3rr3n4#123 "BD/Noviembre/10_11_2025/CREATE_VW_SESION_DPR.sql" terrena@100.126.124.101:/tmp/
...
### Scripts SQL
- `BD/Noviembre/10_11_2025/CREATE_VW_SESION_DPR.sql` - Script de creación de la vista
