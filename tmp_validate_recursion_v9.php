...
try {
    ...
    // Create a Mock Ticket (CORRECTED SCHEMA)
    $ticketId = 12 * (time() % 100000); 
    ...
    DB::connection('pos_pg')->table('public.ticket_item')->insert([
        'ticket_id' => $ticketId, 'item_id' => 99999, 'item_name' => 'Test Base', 'item_quantity' => 1, 'item_price' => 100, 'tax_amount' => 0
    ]);
