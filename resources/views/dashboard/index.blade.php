...
<div class="dashboard-grid py-3">
  ...
  {{-- Barra de filtros (markup y clases legacy) --}}
  ...
  {{-- KPIs (misma estructura y clases del legacy) --}}
  <div class="kpi-grid mb-3">
    ...
    <div class="card-kpi">
      ...
      <div class="text-muted small">Ventas: <strong id="kpi-star-sales">$0.00</strong></div>
    </div>
    <div class="card-kpi">
      <h5 class="card-title"><i class="fa-solid fa-tags"></i> Productos vendidos</h5>
      <div class="kpi-value" id="kpi-items-sold">0</div>
      <div class="text-muted small">vs. ayer <span id="kpi-items-variation" class="text-muted">0%</span></div>
    </div>
    <div class="card-kpi">
      <h5 class="card-title"><i class="fa-solid fa-receipt"></i> Ticket promedio</h5>
      <div class="kpi-value" id="kpi-avg-ticket">$0.00</div>
      <div class="text-muted small">vs. ayer <span id="kpi-ticket-variation" class="text-muted">0%</span></div>
    </div>
    <div class="card-kpi">
        ...
        <div class="table-responsive">
          <table class="table table-sm mb-0 align-middle">
            ...
            <tbody id="kpi-registers">
              <tr><td>—</td><td><span class="badge text-bg-secondary">—</span></td><td class="text-end">-</td></tr>
            </tbody>
          </table>
        </div>
      </div>
    ...
    <div class="col-12 col-xl-7">
      <div class="card-vo">
        ...
        <ul id="activity-list" class="list-unstyled mb-0">
          <li class="text-muted small">Sin datos disponibles</li>
        </ul>
      </div>
    </div>
        ...
        <div class="table-responsive">
          <table class="table table-sm align-middle mb-0">
            ...
            <tbody id="orders-table">
              <tr><td colspan="4" class="text-center text-muted small">Sin órdenes recientes</td></tr>
            </tbody>
          </table>
        </div>
      </div>
...
@push('scripts')
<script>
  // dispara las gráficas UNA sola vez usando tus JS actuales
