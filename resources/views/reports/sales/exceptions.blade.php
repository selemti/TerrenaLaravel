...
<section class="report-shell">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            <h1 class="h3 mb-1"><i class="fa-solid fa-triangle-exclamation text-warning me-2"></i> Excepciones</h1>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('reports.sales.exceptions') }}" class="row g-3 align-items-end">
                <div class="col-md-3">
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <a href="{{ route('reports.sales.exceptions') }}" class="btn btn-outline-secondary flex-fill"><i class="fa-solid fa-rotate-left me-1"></i> Limpiar</a>
                </div>
                    ...
                    <tbody>
                        @forelse($rows as $r)
                            <tr>
                                ...
                                <td>{{ $r->error_code ?? '—' }}</td>
                                <td>{{ $r->severity ?? '—' }}</td>
                                <td class="text-end">${{ number_format((float)($r->diff ?? 0), 2) }}</td>
                            </tr>
                        @empty
