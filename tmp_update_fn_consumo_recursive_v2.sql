-- =============================================================================
-- REFACTORIZACIÓN FINAL: fn_expandir_consumo_ticket (v2.1)
-- SOPORTE: Recursividad Logística + Stock-Aware + Modificadores (Floreant Sync)
-- =============================================================================
...
BEGIN
    ...
    LOOP
        ...
        SELECT 
            ...
            1,
            'AUTO_' || b.path_type, -- Simplificado el origen
    ...
    VALUES (_ticket_id, 'EXPAND_RECURSIVE_2026', jsonb_build_object('ts', now()));
END;
$function$;
