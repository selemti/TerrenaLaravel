...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/caja/cortes/aprobaciones', function () {
        return view('caja.aprobaciones', ['active' => 'aprobaciones']);
    })->middleware('can:ver-alertas-cortes')->name('caja.aprobaciones');
    Route::get('/caja/cortes/historico', [App\Http\Controllers\Caja\CortesHistoricoController::class, 'index'])->name('caja.historico');
    Route::get('/caja/cortes/historico/{id}', [App\Http\Controllers\Caja\CortesHistoricoController::class, 'show'])->name('caja.historico.detalle');
    ...
    if (feature_enabled('admin')) {
        ...
        Route::prefix('admin/tickets')->middleware('can:admin.access')->group(function () {
            ...
            Route::get('/massive-close/range', [\App\Http\Controllers\Admin\TicketManagementController::class, 'getMassiveCloseRange'])->name('admin.tickets.massive-close.range');
