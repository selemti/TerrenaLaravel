# VERIFICACIÓN DEL MAPA BD ↔ CÓDIGO (TODOS LOS MÓDULOS) - Versión Normalizada

**NOTA IMPORTANTE**: Este archivo refleja el estado corregido tras la auditoría de Claude. Las filas que originalmente se marcaban como ERROR_MAPA han sido corregidas para reflejar la realidad de la base de datos.
...
| Inventario | selemti | recepcion | id | NO | FANTASMA | NO_EXISTE | CONFIABLE | Tabla recepcion no existe en BD pero es referenciada en código |
| Inventario | selemti | recepcion | proveedor_id | NO | FANTASMA | NO_EXISTE | CONFIABLE | Tabla recepcion no existe en BD pero es referenciada en código |
| Inventario | selemti | recepcion | almacen_id | NO | FANTASMA | NO_EXISTE | CONFIABLE | Tabla recepcion no existe en BD pero es referenciada en código |
...
| Inventario | selemti | stock_policy | updated_at | SI | OK | OK | CONFIABLE | Update timestamp |
...
| Recetas | selemti | receta_insumo | item_id | SI | OK | OK | CONFIABLE | Item foreign key |
...
| Recetas | selemti | pos_map | receta_id | SI | MISMATCH | OK | CONFIABLE | Código espera receta_version_id pero BD tiene receta_id |
| Recetas | selemti | pos_map | receta_version_id | SI | MISMATCH | OK | CONFIABLE | Código usa receta_version_id pero BD tiene separada receta_id |
...
| Recetas | selemti | pos_map | meta | SI | OK | OK | CONFIABLE | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Recetas | selemti | pos_map | vigente_desde | SI | OK | OK | CONFIABLE | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
...
| POS / Ventas | public | ticket | gratuity_id | SI | OK | OK | CONFIABLE | Gratitude ID |
...
| POS / Ventas | public | ticket_item | has_modiiers | SI | OK | OK | CONFIABLE | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
...
| Caja / Caja chica | selemti | caja_fondo | folio | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | caja_fondo | fecha_apertura | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | caja_fondo | fecha_cierre | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | caja_fondo | estado | SI | OK | OK | CONFIABLE | Status |
| Caja / Caja chica | selemti | caja_fondo | monto_inicial | SI | OK | OK | CONFIABLE | Initial amount |
| Caja / Caja chica | selemti | caja_fondo | responsabilidad_inicio | SI | OK | OK | CONFIABLE | Start responsibility |
| Caja / Caja chica | selemti | caja_fondo | responsabilidad_fin | SI | OK | OK | CONFIABLE | End responsibility |
| Caja / Caja chica | selemti | caja_fondo | monto_real_inicio | SI | OK | OK | CONFIABLE | Real start amount |
| Caja / Caja chica | selemti | caja_fondo | monto_real_fin | SI | OK | OK | CONFIABLE | Real end amount |
| Caja / Caja chica | selemti | caja_fondo | monto_sistema_inicio | SI | OK | OK | CONFIABLE | System start amount |
| Caja / Caja chica | selemti | caja_fondo | monto_sistema_fin | SI | OK | OK | CONFIABLE | System end amount |
| Caja / Caja chica | selemti | caja_fondo | monto_contable_inicio | SI | OK | OK | CONFIABLE | Accounting start amount |
| Caja / Caja chica | selemti | caja_fondo | monto_contable_fin | SI | OK | OK | CONFIABLE | Accounting end amount |
| Caja / Caja chica | selemti | caja_fondo | diferencia_efectivo | SI | OK | OK | CONFIABLE | Cash difference |
| Caja / Caja chica | selemti | caja_fondo | diferencia_no_efectivo | SI | OK | OK | CONFIABLE | Non-cash difference |
| Caja / Caja chica | selemti | caja_fondo | diferencia_total | SI | OK | OK | CONFIABLE | Total difference |
| Caja / Caja chica | selemti | caja_fondo | observaciones | SI | OK | OK | CONFIABLE | Observations |
| Caja / Caja chica | selemti | caja_fondo | estado_apertura | SI | OK | OK | CONFIABLE | Opening status |
| Caja / Caja chica | selemti | caja_fondo | estado_cierre | SI | OK | OK | CONFIABLE | Closing status |
| Caja / Caja chica | selemti | caja_fondo | ts_apertura | SI | OK | OK | CONFIABLE | Opening timestamp |
| Caja / Caja chica | selemti | caja_fondo | ts_cierre | SI | OK | OK | CONFIABLE | Closing timestamp |
| Caja / Caja chica | selemti | caja_fondo | responsable_apertura_id | SI | OK | OK | CONFIABLE | Opening responsible ID |
| Caja / Caja chica | selemti | caja_fondo | responsable_cierre_id | SI | OK | OK | CONFIABLE | Closing responsible ID |
| Caja / Caja chica | selemti | caja_fondo | usuario_apertura_id | SI | OK | OK | CONFIABLE | Opening user ID |
| Caja / Caja chica | selemti | caja_fondo | usuario_cierre_id | SI | OK | OK | CONFIABLE | Closing user ID |
...
| Caja / Caja chica | selemti | caja_fondo_mov | caja_fondo_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
...
| Caja / Caja chica | selemti | caja_fondo_mov | descripcion | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | caja_fondo_mov | referencia_tipo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | caja_fondo_mov | referencia_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | caja_fondo_mov | usuario_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | caja_fondo_mov | proveedor_id | SI | FANTASMA | OK | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
...
| Caja / Caja chica | selemti | cash_funds | folio | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_funds | responsable_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_funds | monto_inicial | SI | OK | OK | CONFIABLE | Initial amount |
| Caja / Caja chica | selemti | cash_funds | monto_sistema | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_funds | monto_real | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_funds | diferencia | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_funds | estado | SI | OK | OK | CONFIABLE | Status field |
| Caja / Caja chica | selemti | cash_funds | observaciones | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_funds | fecha_apertura | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_funds | fecha_cierre | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_funds | aprobada_por | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
...
| Caja / Caja chica | selemti | cash_fund_movements | descripcion | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_fund_movements | referencia_tipo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_fund_movements | referencia_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_fund_movements | usuario_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | cash_fund_movements | proveedor_id | SI | FANTASMA | OK | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
...
| Caja / Caja chica | selemti | sesion_cajon | id | SI | OK | OK | CONFIABLE | Primary key |
| Caja / Caja chica | selemti | sesion_cajon | usuario_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | terminal_id | SI | OK | OK | CONFIABLE | Terminal ID |
| Caja / Caja chica | selemti | sesion_cajon | cajero_usuario_id | SI | OK | OK | CONFIABLE | Cashier user ID |
| Caja / Caja chica | selemti | sesion_cajon | apertura_ts | SI | OK | OK | CONFIABLE | Opening timestamp |
| Caja / Caja chica | selemti | sesion_cajon | cierre_ts | SI | OK | OK | CONFIABLE | Closing timestamp |
| Caja / Caja chica | selemti | sesion_cajon | sistema_efectivo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | sistema_total | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | sistema_descuentos | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | sistema_anulaciones | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | sistema_retiros | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | sistema_efectivo_esperado | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | declarado_precorte_efectivo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | declarado_post_efectivo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | declarado_post_tarjetas | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | diferencia_efectivo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | diferencia_no_efectivo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | created_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Caja / Caja chica | selemti | sesion_cajon | updated_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Finanzas | selemti | formas_pago | id | SI | FANTASMA | OK | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Finanzas | selemti | formas_pago | codigo | SI | FANTASMA | OK | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_valorizado | item_key | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_valorizado | sucursal_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_valorizado | stock | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_valorizado | costo_wac | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_valorizado | valor | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_brechas | sucursal_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_brechas | item_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_brechas | min_qty | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_brechas | max_qty | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_brechas | stock_actual | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_brechas | faltante | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Reports / KPIs | selemti | vw_stock_brechas | excedente | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | users | id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | users | name | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | users | email | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | users | email_verified_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | users | password | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | users | remember_token | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | users | created_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | users | updated_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | model_has_permissions | id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | model_has_permissions | permission_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | model_has_permissions | model_type | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | model_has_permissions | model_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | model_has_roles | id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | model_has_roles | role_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | model_has_roles | model_type | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | model_has_roles | model_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | permissions | id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | permissions | name | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | permissions | guard_name | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | permissions | created_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | permissions | updated_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | roles | id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | roles | name | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | roles | guard_name | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | roles | created_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Seguridad | public | roles | updated_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Catálogos | selemti | cat_unidades | descripcion | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Catálogos | selemti | cat_almacenes | codigo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Catálogos | selemti | cat_almacenes | descripcion | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Catálogos | selemti | cat_sucursales | codigo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
| Catálogos | selemti | cat_sucursales | direccion | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría Claude: mapping estaba mal, BD y código sí coinciden. |
