# VERIFICACIÓN DEL MAPA BD ↔ CÓDIGO (TODOS LOS MÓDULOS) - Versión Normalizada Post-Auditoría

**NOTA IMPORTANTE**: Este archivo refleja el estado corregido tras la auditoría completa con CLAUDE. Los registros que originalmente se marcaban como ERROR_MAPA han sido corregidos para reflejar la realidad real de la base de datos.
...
| Inventario | selemti | transfer_cab | estado | SI | OK | OK | CONFIABLE | Status enum: Corregido por auditoría CLAUDE: mapping estaba mal, BD y código sí coinciden. |
...
| POS / Ventas | public | ticket | deliveery_date | SI | OK | OK | CONFIABLE | Delivery date typo |
...
| POS / Ventas | public | ticket | customer_pickeup | SI | OK | OK | CONFIABLE | Customer pickup typo |
...
| Caja / Caja chica | selemti | caja_fondo | folio | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | caja_fondo | fecha_apertura | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | caja_fondo | fecha_cierre | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
...
| Caja / Caja chica | selemti | caja_fondo_mov | descripcion | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | caja_fondo_mov | referencia_tipo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | caja_fondo_mov | referencia_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | caja_fondo_mov | usuario_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | caja_fondo_mov | proveedor_id | SI | FANTASMA | OK | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna SÍ existe en BD |
...
| Caja / Caja chica | selemti | cash_funds | folio | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | cash_funds | responsable_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
...
| Caja / Caja chica | selemti | cash_funds | observaciones | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
...
| Caja / Caja chica | selemti | cash_fund_movements | descripcion | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | cash_fund_movements | referencia_tipo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | cash_fund_movements | referencia_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | cash_fund_movements | usuario_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | cash_fund_movements | proveedor_id | SI | FANTASMA | OK | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna SÍ existe en BD |
...
| Caja / Caja chica | selemti | sesion_cajon | usuario_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
...
| Caja / Caja chica | selemti | sesion_cajon | sistema_efectivo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | sistema_total | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | sistema_descuentos | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | sistema_anulaciones | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | sistema_retiros | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | sistema_efectivo_esperado | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | declarado_precorte_efectivo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | declarado_post_efectivo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | declarado_post_tarjetas | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | diferencia_efectivo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | diferencia_no_efectivo | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | created_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Caja / Caja chica | selemti | sesion_cajon | updated_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Finanzas | selemti | formas_pago | id | SI | FANTASMA | OK | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, tabla SÍ existe en BD |
| Finanzas | selemti | formas_pago | codigo | SI | FANTASMA | OK | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, tabla SÍ existe en BD |
| Reports / KPIs | selemti | vw_stock_valorizado | item_key | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Reports / KPIs | selemti | vw_stock_valorizado | sucursal_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Reports / KPIs | selemti | vw_stock_valorizado | stock | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Reports / KPIs | selemti | vw_stock_valorizado | costo_wac | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Reports / KPIs | selemti | vw_stock_valorizado | valor | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Reports / KPIs | selemti | vw_stock_brechas | sucursal_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Reports / KPIs | selemti | vw_stock_brechas | item_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Reports / KPIs | selemti | vw_stock_brechas | min_qty | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Reports / KPIs | selemti | vw_stock_brechas | max_qty | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Reports / KPIs | selemti | vw_stock_brechas | stock_actual | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Reports / KPIs | selemti | vw_stock_brechas | faltante | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Reports / KPIs | selemti | vw_stock_brechas | excedente | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | users | id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | users | name | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | users | email | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | users | email_verified_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | users | password | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | users | remember_token | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | users | created_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | users | updated_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | model_has_permissions | id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | model_has_permissions | permission_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | model_has_permissions | model_type | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | model_has_permissions | model_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | model_has_roles | id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | model_has_roles | role_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | model_has_roles | model_type | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | model_has_roles | model_id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | permissions | id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | permissions | name | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | permissions | guard_name | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | permissions | created_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | permissions | updated_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | roles | id | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | roles | name | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | roles | guard_name | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | roles | created_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
| Seguridad | public | roles | updated_at | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
...
| Catálogos | selemti | cat_unidades | descripcion | NO | OK | NO_EXISTE | ERROR_MAPA | Corregido por auditoría CLAUDE: mapping estaba mal, columna NO existe en BD |
...
| Catálogos | selemti | cat_almacenes | clave | SI | OK | OK | CONFIABLE | Code field |
...
| Catálogos | selemti | cat_sucursales | clave | SI | OK | OK | CONFIABLE | Code field |
