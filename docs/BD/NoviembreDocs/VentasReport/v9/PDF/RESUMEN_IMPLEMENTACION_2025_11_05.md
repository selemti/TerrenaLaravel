...
Referencias:
- `docs/docs/BD/NoviembreDocsDocs/VentasReport/v9/script_sql_reportes_adicionales.sql`
- `database/sql/reportes/script_sql_reportes_adicionales.sql`
- Bloques rápidos para crear vistas faltantes: `docs/docs/BD/NoviembreDocsDocs/VentasReport/v9/PDF/COMANDOS_SQL_VISTAS.sql`
