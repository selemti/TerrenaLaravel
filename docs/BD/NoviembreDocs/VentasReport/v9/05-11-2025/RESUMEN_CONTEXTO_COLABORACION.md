...
- Se actualizaron los scripts SQL en `database/sql/reportes/script_sql_reportes_adicionales.sql` (y espejos bajo `docs/docs/BD/NoviembreDocsDocs/VentasReport/v9/`) para:
...
- Pendiente refrescar las vistas en base de datos para reflejar estos cambios y validar cifras contra los PDF ubicados en `docs/docs/BD/NoviembreDocsDocs/VentasReport/v9/PDF/FloreantPOS`.
...
- Scripts SQL y documentación complementaria: `database/sql/reportes/script_sql_reportes_adicionales.sql`, `docs/docs/BD/NoviembreDocsDocs/VentasReport/v9/PDF/AUDITORIA_REPORTES_FLOREANT_vs_TERRENA.md`, PDFs de Jasper bajo `docs/docs/BD/NoviembreDocsDocs/VentasReport/v9/PDF/FloreantPOS`.
