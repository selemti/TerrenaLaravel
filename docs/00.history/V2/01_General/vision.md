...
Consulta los diccionarios actualizados en `docs/V2/02_Database/schema_public.md` y `docs/V2/02_Database/schema_selemti.md`, y el ERD en `docs/BD/DOC_ERD-FULL-20251017-081101.md`.
