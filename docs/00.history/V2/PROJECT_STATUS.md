...
- `docs/BD/DOC_ERD-FULL-20251017-081101.md`: diagrama entidad-relación consolidado.
...
- **Documentación Local**: `docs/V2/01_General/vision.md`, `docs/V2/02_Database/schema_public.md`, `docs/V2/02_Database/schema_selemti.md`, `docs/BD/DOC_ERD-FULL-20251017-081101.md`, `docs/CajaChica/WIZARD_CORTE_CAJA-20251017-0258.md`.  
