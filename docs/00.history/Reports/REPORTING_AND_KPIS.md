...
- Enlazar con `docs/Seguridad/AUDIT_LOG_POLICY.md`.

## Actualizaciones Recientes
- 2025-12-06: se liberó el dashboard operativo (`docs/Reports/REPORTING_AND_KPIS_DASHBOARD_WEEK6.md`) con Livewire + Chart.js, exportación CSV/PDF y favoritos por usuario. Todos los KPIs listados arriba están cubiertos parcialmente; restan márgenes y notas operativas para fase 2.
