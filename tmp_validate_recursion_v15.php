...
try {
    // Apply function v2.5
    $sql = file_get_contents(__DIR__ . '/tmp_update_fn_consumo_recursive_v2_5.sql');
    DB::connection('pgsql')->unprepared($sql);
    echo "SUCCESS: Recursive Function v2.5 Applied.\n";
    ...
    // -------------------------------------------------------------------------
    echo "--- TEST 1: NO STOCK (Expected: Explosion to Insumo MP_ID: 999) ---\n";
